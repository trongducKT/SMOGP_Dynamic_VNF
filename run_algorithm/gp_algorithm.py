...
def run_MOEAD(data_path, processing_num, num_train,  
                ...
                pop_size, max_gen,  min_height, max_height, initialization_max_height,  
                num_of_tour_particips, tournament_prob,crossover_rate, mutation_rate,
                reproduce_opertation, initialize_operator, selection_operator, neighborhood_size,
                calFitness):
    data = Read_data(data_path)
    request_list = data.get_R()
    vnf_list = data.get_F()
    ...
    #                                               reproduce_opertation, initialize_operator, selection_operator,
    #                                               calFitness)
    sum_gen, time_train, fitness_history = trainMOGPD(processing_num, network, vnf_list, request_list,
               functions, terminal_decision, terminal_choosing,
               pop_size, max_gen, min_height, max_height, initialization_max_height,
