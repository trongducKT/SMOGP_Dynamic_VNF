...
if __name__ == '__main__':
    path_nsf=[r'./data_1_9/nsf_rural_easy_s2.json', r'./data_1_9/nsf_uniform_easy_s1.json', r'./data_1_9/nsf_uniform_hard_s2.json', r'./data_1_9/nsf_urban_normal_s1.json']
    for path in path_nsf:
        print(path)
#         result = {}
#         result["dataset"] = path
        fitness, rejected, cost, proc, sum_gen, fitness_train, time_train, fitness_history = run_proposed(path, 100, 0.5, 10, 45, 2, 8, 4, 10, 100, 0.8, 0.1 )
